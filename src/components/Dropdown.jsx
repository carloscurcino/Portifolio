        ...
        {isExpanded &&
            <div className='absolute bg-white rounded border-gray text-black mt-[0.10rem] ml-2 cursor-pointer w-11 h-19'>
                <ul>
                    ...
                    <li onClick={()=>handleClick(br, "ptBR")} className='px-0 flex justify-center items-center mt-[0.10rem] hover:bg-cyan-400 hover:text-white h-7'><img className='w-full h-6 hover:scale-125 duration-500 rounded' src={br} alt="Brazil flag, symbolizing the brazillian portuguese laguage"/></li>
                </ul>
            </div>
        }
    </div>
